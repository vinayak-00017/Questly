...
export function TimezoneSelectDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg bg-gradient-to-br from-slate-800/95 via-slate-900/95 to-slate-800/95 border-amber-500/20 backdrop-blur-sm">
        ...
        <DialogFooter className="pt-4">
          ...
          >
            ...
            <Button
              ...
              className="bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-slate-900 font-medium shadow-lg shadow-amber-500/20 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
