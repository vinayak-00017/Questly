...
const AppRightSidebar = () => {
  return (
    <div className="fixed right-0 top-0 z-40 h-full w-[280px] bg-white dark:bg-neutral-800 border-l border-neutral-200 dark:border-neutral-700 hidden md:block">
