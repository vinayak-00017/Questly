...
const QuestManager = () => {
    ...
    const getPriorityOrder = (priority: QuestPriority): number => {
        switch (priority) {
            ...
            case QuestPriority.Important: return 4;
            case QuestPriority.Standard: return 3;
            case QuestPriority.Minor: return 2;
            case QuestPriority.Optional: return 1;
            default: return 3;
        }
    };
    ...
    const filteredTemplates = (templatesData || [])
        .filter((template) => {
            ...
            return matchesSearch && matchesStatus && matchesQuestType && matchesImportance;
        })
        .sort((a, b) => {
